...
use Validator;
class BOModifyController extends Controller
{
    /**
    ...
    {
        $data['bomodifies'] = BOModify::latest()->get();
        return view('backend.bomodifies.view',$data);
    }
    ...
    {
        $data['bomodify'] = BOModify::find($id);
        ...
        return view('backend.bomodifies.bomodifypdf',$data);
    }
