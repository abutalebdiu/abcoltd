            ...
            <section class="join-section clearfix py-5">
                <div class="custom-container">
                    ...
                    @endforeach --}}
                        ...
                        <form id="myform" class="seller-step-form" action="{{ route('boopening.single.store') }}"
                                ...
                                <div class="row mobile-input-box">
                                        ...
                                        <div class="py-2 d-flex bd-highlight">
                                            ...
                                            <div class="form-right w-100 bd-highlight">
                                                <input id="father" type="text" name="father"
                                                    value="{{ old('father') }}" placeholder="Father Name">
                                    ...
                                    <div class="col-12">
                                        <div class="py-2 d-flex bd-highlight">
                                            ...
                                            <div class="form-right w-100 bd-highlight">
                                                <input id="mother" type="text" name="mother" id="mother"
                                                    value="{{ old('mother') }}" placeholder="Mother Name">
                                        ...
                                        <div class="py-2 d-flex bd-highlight">
                                            ...
                                            <div class="form-right w-100 bd-highlight">
                                                <select name="sex" id="gender">
                                                    ...
                                                    <option {{ old('sex') == 1 ? 'selected' : '' }} value="1">Male
                                                    </option>
                                                    <option {{ old('sex') == 2 ? 'selected' : '' }} value="2">Female
                                                    </option>
                                                </select>
                                    ...
                                    <div class="col-12">
                                        <div class="py-2 d-flex bd-highlight">
                                            ...
                                            <div class="form-right w-100 bd-highlight">
                                                <input id="date" type="date" name="birthday_date"
                                    ...
                                    <div class="col-12">
                                        <div class="py-2 d-flex bd-highlight">
                                            ...
                                            <div class="form-right w-100 bd-highlight">
                                                <input type="text" name="profession" id="occupation"
                                                    placeholder="Occupation" value="{{ old('profession') }}">
                                    ...
                                    <div class="col-12">
                                        <div class="py-2 d-flex bd-highlight">
                                            ...
                                            <div class="form-right w-100 bd-highlight">
                                                <input id="postal" type="text" name="zip_code"
                                                    value="{{ old('zip_code') }}" placeholder="Postal Code">
                                    ...
                                    <div class="col-12">
                                        <div class="py-2 d-flex bd-highlight">
                                            ...
                                            <div class="form-right w-100 bd-highlight">
                                                <input type="file" name="nid_attachment"
                                                    value="{{ old('nid_attachment') }}" id="nida">
                                    ...
                                    <div class="col-12">
                                        <div class="py-2 d-flex bd-highlight">
                                            ...
                                            <div class="form-right w-100 bd-highlight">
                                                <input type="file" name="sign" value="{{ old('sign') }}"
                                                    id="sign">
                                        ...
                                        <div class="py-2 d-flex bd-highlight">
                                            ...
                                            <div class="form-right w-100 bd-highlight">
                                                <input type="text" name="account" value="{{ old('account') }}"
                                                    id="account" placeholder="Bank Cccount Number">
                                        ...
                                        <div class="py-2 d-flex bd-highlight">
                                            ...
                                            <div class="form-right w-100 bd-highlight">
                                                <input type="text" name="routing" value="{{ old('routing') }}"
                                                    id="routing" placeholder="Routing Number">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="py-2 d-flex bd-highlight">
                                            ...
                                            <div class="form-right w-100 bd-highlight">
                                                <input type="text" name="n_name" value="{{ old('n_name') }}"
                                                    id="nomineee " placeholder="Nomineee  Name">
                                        ...
                                        <div class="py-2 d-flex bd-highlight">
                                            ...
                                            <div class="form-right w-100 bd-highlight">
                                                <input type="text" name="relation" value="{{ old('relation') }}"
                                                    id="relationship" placeholder="Relationship">
                                    ...
                                    <div class="col-12">
                                        <div class="py-2 d-flex bd-highlight">
                                            ...
                                            <div class="form-right w-100 bd-highlight">
                                                <input type="text" name="n_mobile" value="{{ old('n_mobile') }}"
                                                    id="n_mobile" placeholder="Nomineee mobile Number">
                                    ...
                                    <div class="col-12">
                                        <div class="py-2 d-flex bd-highlight">
                                            ...
                                            <div class="form-right w-100 bd-highlight">
                                                <input type="text" name="n_nid" value="{{ old('n_nid') }}"
                                                    id="nnid" placeholder="nominee NID No">
                                    ...
                                    <div class="col-12">
                                        <div class="py-2 d-flex bd-highlight">
                                            ...
                                            <div class="form-right w-100 bd-highlight">
                                                <input name="n_nid_att" value="{{ old('n_nid_att') }}" type="file"
                                                    id="nna">
                                    ...
                                    <div class="col-12">
                                        <div class="py-2 d-flex bd-highlight">
                                            ...
                                            <div class="form-right w-100 bd-highlight">
                                                <input type="file" name="n_photo" value="{{ old('n_photo') }}"
                                                    id="n_photo">
