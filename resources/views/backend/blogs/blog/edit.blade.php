                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        <div class="py-2">
                                                                            ...
                                                                            <input type="text" id="name" name="title" class="form-control" value="{{ $blog->title }}" id="" placeholder=" Blog Title">
                                                                        ...
                                                                        <div class="py-2">
                                                                            ...
                                                                            <textarea name="description" id="summernote" class="form-control" placeholder="description">{{$blog->description}}</textarea>
