...
@section('title','User Rejected List')
@section('content')
 <div id="content" class="content">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <h4 class="panel-title">User Rejected List</h4>
                    ...
                    <table id="data-table-default" class="table table-striped table-bordered table-td-valign-middle">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('user.show', $user->id) }}" class="btn btn-xs btn-secondary mt-1">
                            		<i class="fa fa-eye"></i> Show
                            	</a> 
                                 <a href="{{ route('user.delete', $user->id) }}"  id="delete" class="btn btn-xs btn-danger mt-1">
                            		<i class="fa fa-trash"></i> Full Delete
                            	</a> 
