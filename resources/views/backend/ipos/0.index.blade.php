    ...
    <div id="content" class="content">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">All IPO  </h4>
            ...
            <div class="panel-body">
                ...
                <a href="{{route('ipo.create')}}" class="btn btn-primary btn-sm float-right mb-1" id="create-new-class"><i class="fa fa-plus"></i> Add ipo</a>
                    ...
                    @foreach($ipos as $ipo)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('ipo.admin.destroy',$ipo->id)}}" id="delete" class="btn btn-danger btn-sm"> <i class="fa fa-trash"></i> Delate</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
