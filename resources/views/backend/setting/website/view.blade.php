                    ...
                    <table id="data-table-default" class="table table-striped table-bordered table-td-valign-middle">
						...
						<tr>
                         ...
                         <tr>
                          ...
                          <tr>
                         	<th>Home Page BO Open Image</th>
                         	<td>
                         	<img src="{{ asset($setting->home_page_boopen) }}" alt="" width="10%">
                         	</td>
                         </tr>
                         ...
                         <tr>
                         	<th> BO Open Price </th>
                         	<td>
                         		{{ $setting->bo_open_price }}
                         	</td>
                         </tr>


                         <tr>
                         	<th> BO Open Requirement </th>
                         	<td>
                         		{!! $setting->bo_open_requirement !!}
                         	</td>
                         </tr>
