                            ...
                            <form action="{{ route('website.setting.update') }}" method="POST" enctype="multipart/form-data">
                            	@csrf
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="">BO Open Home Page Image</label>
                                         <input type="file" name="home_page_boopen" class="form-control">
                                        <div class="text-danger">{{ $errors->first('home_page_boopen') }}</div>
                                    </div> 
                                    
                                    
                                    <div class="form-group">
                                        <label for="">BO Open Price</label>
                                        <input type="text"  name="bo_open_price" value="{{ $setting->bo_open_price }}" class="form-control" placeholder="BO Open Price" /> 
                                        <div class="text-danger">{{ $errors->first('bo_open_price') }}</div>
                                    </div>
                                    
                                    
                                    
                                    <div class="form-group">
                                        <label for="">BO Open Requirement</label>
                                        <textarea  name="bo_open_requirement"  class="form-control summernote" placeholder="BO Open Requirement"></textarea>
                                        <div class="text-danger">{{ $errors->first('bo_open_requirement') }}</div>
                                    </div>
